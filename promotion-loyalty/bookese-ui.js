...
function renderBookeseCatalog() {
  const sections = [
    ...
    ['Ưu đãi tiếp thị', 'Chỗ nghỉ tham gia khung chiến dịch do Bookese mở.', [['campaign','Tiếp thị','Đăng ký trong khung đã duyệt']]],
...
document.head.insertAdjacentHTML('beforeend',`<style>
:root{--bg:#f7f7fb;--blue:#00b9ed}.sidebar{width:250px;padding:13px 0;overflow:auto}.sidebar .logo{font-size:39px;margin:0 45px 23px;text-align:left;letter-spacing:-2px}.sidebar .logo::after{content:none}.sidebar .navitem{font-size:13px;height:auto;justify-content:flex-start;padding:11px 24px}.sidebar .navitem::first-letter{font-size:13px}.shell{margin-left:250px}.bookese-panel{max-width:none;border:0;border-radius:3px}.bookese-catalog{grid-template-columns:1fr}.bookese-option{min-height:96px;padding:20px 28px}.bookese-form{max-width:800px;margin:auto}.bookese-form .primary{background:#00b9ed;border-color:#00b9ed}.topnav{font-size:13px}.sidebar .sub{padding-left:55px;font-size:12px}@media(max-width:800px){.sidebar{width:190px}.sidebar .logo{margin-left:24px}.shell{margin-left:190px}}@media(max-width:650px){.sidebar{display:none}.shell{margin-left:0}}
</style>`);
document.querySelector('.sidebar').innerHTML=`<div class="logo">bookese</div><a class="navitem active" href="promotions.html">▣　Quản lý chỗ nghỉ</a>${['♡　Danh sách yêu thích','▤　Quản lý đặt chỗ','♧　Quản lý khách hàng','▥　Quản lý doanh thu','☆　Quản lý đánh giá','▧　Quản lý nội dung','♙　Quản lý tài khoản','◷　Quản lý thao tác','▱　Quản lý thanh toán'].map(x=>`<div class="navitem">${x}</div>`).join('')}<a class="navitem" href="intranet.html#coins">♧　Quản lý xu</a><a class="navitem" href="intranet.html#marketing">⚙　Quản lý khuyến mãi</a><div class="navitem">%　Quản lý thuế</div><a class="navitem" href="intranet.html#campaigns">♧　Quà tặng</a><a class="navitem sub" href="intranet.html#campaigns">Quản lý chiến dịch</a><a class="navitem sub" href="intranet.html#gifts">Danh sách quà tặng</a>`;
