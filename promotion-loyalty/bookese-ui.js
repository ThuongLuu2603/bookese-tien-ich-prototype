...
document.querySelector('.sidebar').innerHTML=`<div class="logo">bookese</div><a class="navitem active" href="promotions.html">▣　Quản lý chỗ nghỉ</a>${['♡　Danh sách yêu thích','▤　Quản lý đặt chỗ','♧　Quản lý khách hàng','▥　Quản lý doanh thu','☆　Quản lý đánh giá','▧　Quản lý nội dung','♙　Quản lý tài khoản','◷　Quản lý thao tác','▱　Quản lý thanh toán'].map(x=>`<div class="navitem">${x}</div>`).join('')}<a class="navitem" href="intranet.html#coins">♧　Quản lý xu</a><a class="navitem" href="intranet.html#marketing">⚙　Quản lý khuyến mãi</a><div class="navitem">%　Quản lý thuế</div><a class="navitem" href="intranet.html#campaigns">♧　Quà tặng</a><a class="navitem sub" href="intranet.html#campaigns">Quản lý chiến dịch voucher</a><a class="navitem sub" href="intranet.html#gifts">Danh sách quà tặng</a>`;
